  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        ...
        maxPricesData.push(
          maxPricesData[maxPricesData.length - 1] +
            maxPricesData[maxPricesData.length - 1] * 0.1
        );
    ...
    scales: {
      ...
      y: {
        ...
        title: {
          ...
          text: "Price",
          // suggestedMax:
          // (maxPrices[maxPrices.length-1]+ maxPrices[maxPrices.length-1]*0.1)
          // color: "white",
        },
      },
      // plugins: {
